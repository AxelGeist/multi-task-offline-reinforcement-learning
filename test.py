...
def initialize_envs():
    ...
    # train_env = wrap_env(gym_wrapper(gym.make(TrainConfig.env_name, 
    ...
    # eval_100_env = wrap_env(gym_wrapper(gym.make(TrainConfig.env_name, 
    ...
    # eval_0_env = wrap_env(gym_wrapper(gym.make(TrainConfig.env_name, 
    ...
    return {
        "train": wrap_env(gym_wrapper(gym.make(TrainConfig.env_name))),
        # "train": train_env,
...
@pyrallis.wrap()
def train(config: TrainConfig, dataset_tuple: tuple):
    ...
    # eval_env = wrap_env(gym_wrapper(gym.make(TrainConfig.env_name, 
    #     agent_pos=train_config['agent positions'],
    #     goal_pos=train_config['goal positions'],
    #     doors_pos=train_config['topologies'],
    #     agent_dir=train_config['agent directions'],
